...
@Component({
  selector: 'add-sms-evently-modal',
  templateUrl: './add-sms-evently-modal.component.html',
  styleUrls: ['./add-sms-evently-modal.component.scss']
})
export class AddSmsEventlyModalComponent implements OnInit {
  ssForm: FormGroup;
  ssModel: ScheduleSmsInfoModel;
  isLoading = false;
  isEdit = false;
  height = window.screen.availHeight - 320;
  header = 'ارسال مناسبتی';
  numberDisplay: any[] = [];
